    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white text-gray-800 px-6 py-12">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg mb-4">
          Bitlinks is your go-to URL shortener designed to simplify long, messy links and make them easier to share. Whether you&aposre managing links for social media, campaigns, or just want to make things look cleaner, Bitlinks has your back.
        </p>
        <p className="text-lg mb-4">
